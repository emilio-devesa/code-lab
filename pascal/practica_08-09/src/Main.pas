...
begin
    case (option) of
        ...
        4: case (submenuLists) of
                ...
                3: { List students and their season grades descendentally sorted } ListController.listStudentsByDescendingSeasonGrades(StudentController.studentsList, GradesController.gradesList);
                0: { Return };
            end;
